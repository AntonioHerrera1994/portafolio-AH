...
<section id="projects" className="py-16 px-6 max-w-4xl mx-auto" data-aos="fade-up">
  ...
  <div className="grid gap-6 md:grid-cols-2">
    ...
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
      <h3 className="text-xl font-semibold">Portafolio Personal</h3>
...
<section id="contact" className="py-16 px-6 max-w-4xl mx-auto text-center" data-aos="fade-up">
  ...
  <div class="mt-8">
    <a href="Antonio H - CV.pdf" download className="text-sm text-gray-400 underline">Descargar CV PDF</a>
  </div>
</section>
